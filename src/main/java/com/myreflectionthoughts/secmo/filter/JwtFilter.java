package com.myreflectionthoughts.secmo.filter;

import com.myreflectionthoughts.secmo.service.MyUserDetailService;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    public JwtFilter(ApplicationContext applicationContext, JwtUtils jwtUtils) throws NoSuchAlgorithmException {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(authHeader!=null && authHeader.startsWith("Bearer ")){
            ...
            username = jwtUtils.retrieveUserName(token);
        }
